...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  markup = "<div class='alert alert--".concat(type, "'>").concat(msg, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alerts.showAlert)('success', 'Successefully logged out');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successefully loged in');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2xlZ3M3NzciLCJhIjoiY2tmZ2pkd3BhMHA0cjJ0cXY2bnF3ejJtYiJ9.tpuh7yaxFpWdr5Iru4nMGw'; // const locations = JSON.parse(
  ...
  var map = new mapboxgl.Map({
    ...
    // interactive: false,
    scrollZoom: false // center: [-73.5804, 45.53483],
    // pitch: 0,
    // bearing: -60,
    // zoom: 10,
...
var stripe = Stripe('pk_test_51HYQowAwETtguWEQkKgdyt1IZgugTb4uPkJCxyDnbdzezk3Ei7WehhHwc74nrEmMgLiWSb9KZcYOIwGXbko763Hx00m3F7KcZt');
...
if (loginForm) {
  document.querySelector('.form--login').addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value; // console.log('email', email);
