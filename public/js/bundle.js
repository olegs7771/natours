      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return _axios.default.post('http://127.0.0.1:8000/api/v1/users/login', data);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2xlZ3M3NzciLCJhIjoiY2tmOTdqb2hoMGI5ZTMybGRlOThmZW1lciJ9.VaNwOUNQ0qe6cicT0UsCGQ';
